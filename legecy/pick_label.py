...
# Only convert labels of images in input_dir.
# This script is used when you want to generate training data's labels.
...
out_dir = "/Users/lucky/Desktop/bdd100k/bdd100k_daytime/train_label/"
...
for name in files:
  ...
  with open(out_dir + name.split('.')[0] + '.txt', 'w') as f:
    ...
    for det in label[name]:
      ...
      f.write(string)
print("Total " + str(c) + " files is created.")